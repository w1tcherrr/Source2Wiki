...
:::bug
Currently when working on your script, when you load your map the script will fail to execute, 
to fix it you need to save the script file in your text editor which will cause the script to be recompiled and start working.
